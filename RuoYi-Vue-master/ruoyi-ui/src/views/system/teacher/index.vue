<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="系统管理员id" prop="userId">
        <el-input
          v-model="queryParams.userId"
          placeholder="请输入系统管理员id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="teacherList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="教师基本信息表主键" align="center" prop="teacherId" />
      <el-table-column label="教师姓名" align="center" prop="name" />
      <el-table-column label="教师工号" align="center" prop="teacherCode" />
      <el-table-column label="系统管理员id" align="center" prop="userId" />
      <el-table-column label="所属部门id" align="center" prop="deptId" />
      <el-table-column label="教师职称" align="center" prop="title">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.bas_teacher_title" :value="scope.row.title"/>
        </template>
      </el-table-column>
      <el-table-column label="手机号码" align="center" prop="phone" />
      <el-table-column label="办公室" align="center" prop="office" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="系统管理员id" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入系统管理员id" />
        </el-form-item>
        <el-form-item label="所属部门id" prop="deptId">
          <el-input v-model="form.deptId" placeholder="请输入所属部门id" />
        </el-form-item>
        <el-form-item label="教师职称" prop="title">
          <el-input v-model="form.title" placeholder="请输入教师职称" />
        </el-form-item>
        <el-form-item label="手机号码" prop="phone">
          <el-input v-model="form.phone" placeholder="请输入手机号码" />
        </el-form-item>
        <el-form-item label="办公室" prop="office">
          <el-input v-model="form.office" placeholder="请输入办公室" />
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        userId: [
          { required: true, message: "系统管理员id不能为空", trigger: "blur" }
        ],
        deptId: [
