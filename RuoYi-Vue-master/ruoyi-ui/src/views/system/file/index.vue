  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="题目编号" prop="exerciseId">
          <el-input v-model="form.exerciseId" placeholder="请输入题目编号" />
        </el-form-item>
        <el-form-item label="消息编号" prop="messageId">
          <el-input v-model="form.messageId" placeholder="请输入消息编号" />
        </el-form-item>
        <el-form-item label="文件名称" prop="name">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除文件，主要保存物理文件的相对路径编号为"' + fileIds + '"的数据项？').then(function() {
