<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="班主任编号" prop="adviserId">
        <el-input
          v-model="queryParams.adviserId"
      ...
      <el-form-item label="学生人数" prop="number">
        <el-input
    ...
    <el-table v-loading="loading" :data="classList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="班主任编号" align="center" prop="adviserId" />
      <el-table-column label="班级名称" align="center" prop="name" />
      <el-table-column label="年级" align="center" prop="grade" />
      <el-table-column label="专业" align="center" prop="major" />
      <el-table-column label="学生人数" align="center" prop="number" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="班主任编号" prop="adviserId">
          <el-input v-model="form.adviserId" placeholder="请输入班主任编号" />
        </el-form-item>
        <el-form-item label="班级名称" prop="name">
        ...
        <el-form-item label="学生人数" prop="number">
          <el-input v-model="form.number" placeholder="请输入学生人数" />
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        adviserId: [
          { required: true, message: "班主任编号不能为空", trigger: "blur" }
        ],
        name: [
